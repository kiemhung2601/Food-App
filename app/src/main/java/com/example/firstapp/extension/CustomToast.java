package com.example.firstapp.extension;
...
public class CustomToast extends Toast {
    ...
    public static Toast makeText(Context context, String message, int duration, int type, boolean androidicon) {
        ...
        if (type == 1) {
            ...
            img.setImageResource(R.drawable.ic_hand_white);
        } else if (type == 3) {
            linearLayout.setBackgroundResource(R.drawable.toast_error);
            img.setImageResource(R.drawable.ic_clear_white);
        } else if (type == 4) {
            linearLayout.setBackgroundResource(R.drawable.toast_confusing);
            img.setImageResource(R.drawable.ic_refresh_white);
        }
